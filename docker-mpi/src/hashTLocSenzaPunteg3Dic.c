...
{
    // Rimuovi la punteggiatura e gli spazi dalla parola e converti le lettere a minuscolo
    int i, j = 0;
...
char *delimiters = " .,;:-_?!"; // Spazio, punto e virgola come separatori
char *token = strtok(local_data, delimiters);
